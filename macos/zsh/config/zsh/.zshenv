...
# Environment variables for XDG Base Directory specification-compliant directories
export XDG_CACHE_HOME="$HOME/.cache"
export XDG_CONFIG_HOME="$HOME/.config"
export XDG_DATA_HOME="$HOME/.local/share"
export XDG_STATE_HOME="$HOME/.local/state"

# Environment variables for macOS-specific directories
export MACOS_USER_LIBRARY="$HOME/Library"

## Cache home
export MACOS_CACHE_HOME="$MACOS_USER_LIBRARY/Caches"
...
## Homebrew
### Cache
export HOMEBREW_CACHE="$MACOS_CACHE_HOME/Homebrew"
...
export ZSH_SCRIPTS_DIR="$SCRIPTS/macos/zsh"
export ZSH_SCRIPTS_DIR_PRIVATE="$SCRIPTS/macos/.private/zsh"
...
## Mouseless
export MOUSELESS_CONFIG_DIR="$XDG_CONFIG_HOME/mouseless"
[ -d "$MOUSELESS_CONFIG_DIR" ] || "$MKDIR_EXECUTABLE" -p "$MOUSELESS_CONFIG_DIR"

### Configurations
export MOUSELESS_CONFIG_FILE="$MOUSELESS_CONFIG_DIR/config.yaml"
...
export PYTHON_SCRIPTS_DIR="$SCRIPTS/macos/python"
...
export RUST_SCRIPTS_DIR="$SCRIPTS/macos/rust"
...
#### Binaries
export RUSTUP_BINARIES_DIR="$RUSTUP_HOME/toolchains/stable-aarch64-apple-darwin/bin"
[ -d "$RUSTUP_BINARIES_DIR" ] || "$MKDIR_EXECUTABLE" -p "$RUSTUP_BINARIES_DIR"
...
#### Mouseless
export STOW_CONFIG_MOUSELESS_DIR="$STOW_CONFIG_HOME/mouseless"
[ -d "$STOW_CONFIG_MOUSELESS_DIR" ] || "$MKDIR_EXECUTABLE" -p "$STOW_CONFIG_MOUSELESS_DIR"
...
#### Packages
export LATEX_FRWYSLND="$LATEX_PACKAGES/frwyslnd" # Git-tracked
export LATEX_MATIC="$LATEX_PACKAGES/matic" # Git-tracked
...
[ -d "$LATEX_FRWYSLND" ] || "$MKDIR_EXECUTABLE" -p "$LATEX_FRWYSLND"
[ -d "$LATEX_MATIC" ] || "$MKDIR_EXECUTABLE" -p "$LATEX_MATIC"
...
#### matic
export MATIC="$ACADEMIC/matic" # Git-tracked
[ -d "$MATIC" ] || "$MKDIR_EXECUTABLE" -p "$MATIC"
