...
path=("$HOME/Projects/Programming/scripts/.private/zsh/file-archiving/bin" $path)
path=("$HOME/Projects/Programming/scripts/.private/zsh/version-control/git/bin" $path)
path=("$HOME/Projects/Programming/scripts/.private/zsh/web-searching/bin" $path)
path=("$HOME/Projects/Programming/scripts/zsh/package-management/fonts/bin" $path)
path=("$HOME/Projects/Programming/scripts/zsh/package-management/homebrew/bin" $path)
path=("$HOME/Projects/Programming/scripts/zsh/typesetting/tex/bin" $path)
path=("$HOME/Projects/Programming/scripts/zsh/typesetting/tex/latex/bin" $path)
path=("$HOME/Projects/Programming/scripts/zsh/version-control/git/bin" $path)
export PATH
...
# Aliases
## bcb | Create Brewfile
alias bcb="$ZSH_SCRIPTS_DIR/package-management/homebrew/bin/create-brewfile"

## bcv | Check versions of Homebrew, installed-on-request Homebrew formulae and casks, and Mac App Store applications
alias bcv="$ZSH_SCRIPTS_DIR/package-management/homebrew/bin/list-homebrew-packages"
